  ...
  return (
    <footer>
      <div className={s.headerFoot}>
        <Container>
          <div className={s.headerFootContent}>
            <h4 className={s.title}>Simplify how your team works today.</h4>
            <Button outline={true} />
          </div>
        </Container>
      </div>
      <div className={s.footerFoot}>
        <Container>
          <div className={s.footerFootContent}>
            <div className={s.links}>
              ...
              <div className={s.linksSoc}>
                <a className={s.linkSoc} href="#top">
            ...
            <nav className={s.nav}>
              <div className={s.columnNav}>
                <a className={s.navLink} href="#top">
                  Home
                </a>
                <a className={s.navLink} href="#top">
                  Pricing
            ...
            <div className={s.formAndRight}>
              <Form />
            </div>
            <p className={s.rights}>Copyright 2020. All Rights Reserved</p>
          </div>
        </Container>
      </div>
    </footer>
